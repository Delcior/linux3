...
CC		= gcc
DEFS		= -DHAVE_CONFIG_H
CFLAGS		= -g -O2 -fdebug-prefix-map=/home/user/zadanie/vim-8.1.0875=. -fstack-protector-strong -Wformat -Werror=format-security -U_FORTIFY_SOURCE -D_FORTIFY_SOURCE=1
CPPFLAGS	= -Wdate-time
srcdir		= .
